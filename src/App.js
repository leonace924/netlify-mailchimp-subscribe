...
const formAPI = "/.netlify/functions/subscribe";
        ...
        <div className="landing-page">
          ...
          <div className="container">
            <div className="row centered">
              <h3 className="logo aligncenter">Netlify functions landing page example</h3>
              ...
              <div className="col-md-6 col-md-offset-3 mt">{this.renderForm()}</div>
            </div>
